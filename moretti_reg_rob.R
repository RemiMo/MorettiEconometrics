...
stargazer(regSurprise1, regSurprise2, regSurprise3, regSurprise4, regSurprise5, regSurprise6, regSurprise7, keep=c('log_screens_first_week'), omit.stat=c("f", "ser"), title='Regression of first-weekend sales on number of screens')
...
stargazer(regPrior1, regPrior2, omit.stat=c("f", "ser"), title='Precision of the prior')
...
# Print a table with the results of the regressions.
stargazer(regSocialNetwork1, regSocialNetwork2, regSocialNetwork3, regSocialNetwork4, omit.stat=c("f", "ser"), title="Precision of peers' signal")
